...
| PDF                   | Description             |
| --------------------- | ----------------------- |
| `xpower-banq.pdf`     | Protocol Whitepaper     |
| `xpower-banq-apx.pdf` | Technical Appendices    |
| `xpower-banq-lck.pdf` | Ring-Buffer Time Locks  |
| `xpower-banq-all.pdf` | Whitepaper & Appendices |
