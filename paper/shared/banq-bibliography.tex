...
% Union of all bibitems from banq-pro, banq-lck, banq-log, banq-mtp,
% banq-sim, and banq-ref, with duplicates removed. Cross-document
% self-references (wp, lck, log, mtp, sim, ref) are retained as ordinary
% entries so \cite calls resolve in bundle mode without requiring
% per-section labels.
%
