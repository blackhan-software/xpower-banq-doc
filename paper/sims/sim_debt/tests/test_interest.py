...
class TestBorrowSupplyRates:
    ...
    def test_no_spread(self):
        """With zero spread, borrow == base and supply == base * util."""
        ...
        assert s == pytest.approx(base * 0.50)

    def test_symmetric_spread(self):
        """With spread, borrow > base > supply (supply utilization-scaled)."""
        spread = 0.10  # 10%
        ...
        assert s == pytest.approx(base * 0.90 * 0.90)
        assert b > s
